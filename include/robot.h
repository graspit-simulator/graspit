...
//
// $Id: robot.h,v 1.54 2009/07/27 15:54:44 cmatei Exp $
//
//######################################################################
...
protected:
 ...
 public:
  ...
  //! Set torque of DOF, as though it were a motor
  void setDOFActivation(double *dofActivation);
...
void scaleHand(const mat3 & scale, Hand * h);
void scaleRobot(const mat3 & scale, Robot * rob);
void scaleChain(const mat3 & scale, KinematicChain * kc);
void scaleLink(const mat3 & scale, Link * l);
void scaleJoint(const mat3 & scale, Joint * j, Link * l);
void scalePalm(const mat3 & scale, Hand * h);
void scaleBody(const mat3 & scale, Body * b);
void scaleGraspableBody(const mat3 & scale, GraspableBody * b);
mat3 normalizeScale(const mat3 & scale, SoScale * myScale);
void setHandMaterial(Hand * h, materialT mat);
void setRobotMaterial(Robot * r, materialT mat);
};
