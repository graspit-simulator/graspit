...
//
// $Id: world.h,v 1.43 2009/06/17 21:10:39 saint Exp $
//
//######################################################################
...
protected:
  //!
	GraspControllerInterface * currentControl;
  ...
  //! A string that is used for socket communication, a deamon at client side asks Graspit for any updated command and executes it
  std::string mCommand;
  bool mCommandActive;
...
public:	
  ...
  void setCommand(std::string cmd) { mCommand = cmd; }
  void resetCommand(){ mCommand.clear(); }
  void setCommandActive(bool t){ mCommandActive = t; }
  bool isCommandACtive(){ return mCommandActive; }
};
