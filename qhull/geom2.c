...
/*-<a                             href="qh-c.htm#geom"
  ...
  design:
    ...
    determine qh.NEARinside, qh.MINnorm, qh.MAXcoplanar, qh.MINvisible,
...
void qh_detroundoff (void) {
  ...
  qh MINnorm= sqrt( REALepsilon) * qh MAXabs_coord; /* FIXUP: what is correct?*/
...
void qh_joggleinput (void) {
  ...
  qh_option ("_joggle-seed", &qh rand_seed, NULL);
  trace0((qh ferr, "qh_joggleinput: joggle input by %2.2g with seed %d\n", 
    qh JOGGLEmax, qh rand_seed));
