...
public:
  ...
  // clones an existing VCollide object; the original and the clone will share
  // the geometry, bounding boxes, etc, but just have different transforms
  int cloneInventorObj(int originalId);
